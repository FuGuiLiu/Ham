        ...
        <ul class="nav navbar-nav navbar-right  hidden-xs">
            ...
            <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i
                ...
                <ul class="dropdown-menu extended notification">
                    ...
                    <li><a href="#"> <span class="photo"> <img src="${pageContext.servletContext.contextPath}/images/profile.png" width="34"
            ...
            <li class="dropdown user  hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i
                    class="icon-male"></i> <span class="username">${sessionScope.txUser.USERNAME}</span> <i class="icon-caret-down small"></i>
            </a>
...
<form id="txForm" method="post" action="${pageContext.servletContext.contextPath}/singer/list.go"
                            ...
                            <div class="widget-content">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：黄家驹" name="SRNAME"
                                                       value="${SRNAME}" id="srname" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：香港" name="AREA" value="${AREA}"
                                        ...
                                        <div class="controls form-group">
                                            <select id="tid" name="TID" class="form-control ">
                                                ...
                                                <c:forEach items="${mtypes}" var="mtype">
                                                    ...
                                                    <option value="${mtype.TID}"
                                                            <c:if test="${mtype.TID == TID}">selected</c:if>>${mtype.TNAME}</option>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class="form-actions text-right">
                                    <div>
                                        ...
                                        <button id="addSinger" class="btn btn-primary" type="button">添加艺人</button>
                                    ...
                                    <table class="table table-striped table-images"
                                        ...
                                        <c:forEach items="${songers}" var="songer">
                                            <tr>
                                                ...
                                                <td><img src="${localPicturesPath}/${songer.PIC}"/>
                                                </td>
                                                <td> ${songer.SRNAME} </td>
                                                <td class="hidden-xs-portrait">${songer.AREA}</td>
                                                <td class="hidden-xs"><p>
                                                    <strong>${songer.IS_HOT == 1?'热门':'一般'}</strong>
                                                </p></td>
                                                <td class="hidden-xs"> ${songer.TNAME}</td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary"><a
                                                            href="/console/singer/change.go?SRID=${songer.SRID}">修改</a>
                                                    </button>
                                                    <button class="btn btn-sm btn-warning"><a
                                                            href="/console/singer/delete.go?SRID=${songer.SRID}">删除</a>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/singerAdd.js"></script>
