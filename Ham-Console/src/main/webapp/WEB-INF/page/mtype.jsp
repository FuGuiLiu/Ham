...
<head>
    ...
    <link href="${pageContext.servletContext.contextPath}/style/style.css" rel="stylesheet"/>
    <link href="${pageContext.servletContext.contextPath}/style/dashboard.css" rel="stylesheet"/>
...
<div class="container">
    <div class="top-navbar header b-b"><a data-original-title="Toggle navigation" class="toggle-side-nav pull-left"
        ...
        <div class="brand pull-left"><a href="/console/index.html"><img src="/../../console/images/logo.png" width="147"
                                                                        height="33"/></a>
        </div>
...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            ...
            <form id="txForm" action="/console/mType/mType.go" method="post" class="form-horizontal">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：摇滚" name="TName" value="${TName}"
...
<div id="mtypePop" style="margin-right: 50px;margin-top: 50px; display: none">
    <form id="addMtypeForm" class="layui-form" method="post" action="" lay-filter="example">
...
<div id="mtypePop1" style="margin-right: 50px;margin-top: 50px; display: none">
    <form id="updateMtypeForm" class="layui-form" method="POST" action=""
          lay-filter="example">
