    ...
    <script>
        ...
        $(function () {
            ...
            $("#addSong").click(function () {
                window.location.href = "/console/song/addSong.go";
            });
...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            ...
            <form id="txForm" action="/console/song/list.go" method="post" class="form-horizontal">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：想你的365天" name="SNAME"
                                                       value="${SNAME}" id="sname" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：李玟" name="SRNAME" value="${SRNAME}"
                                                       id="srname" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                ...
                                                <input type="text" placeholder="如：宝莲灯" name="ANAME" value="${ANAME}"
                                            ...
                                            <select id="tid" name="TID" class="form-control ">
                                                ...
                                                <c:forEach items="${mTypes}" var="mtype">
                                                    <option value="${mtype.TID}"
                                                            <c:if test="${mtype.TID == TID}">selected</c:if>
                                                    >${mtype.TNAME}</option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <table class="table table-striped table-images"
                                        ...
                                        <c:forEach items="${songs}" var="song">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="${localPicturesPath}/${song.PIC}"/>
                                                </td>
                                                <td> ${song.SNAME} </td>
                                                <td class="hidden-xs-portrait">${song.SRNAME}</td>
                                                <td class="hidden-xs"><p><strong>${song.ANAME}</strong></p></td>
                                                <td class="hidden-xs"> ${song.TNAME} </td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary"><a
                                                            href="/console/song/modify.go?SID=${song.SID}">修改</a>
                                                    </button>
                                                    <button class="btn btn-sm btn-warning">
                                                        <a href="/console/song/delete.go?SID=${song.SID}">删除</a>
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
