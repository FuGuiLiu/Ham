...
var file_path_pic = "http://127.0.0.1:8080/pictures/";
var file_path_songs = "http://127.0.0.1:8080/songs/";
    ...
    $(".start em").click(function () {
        ...
        $.ajax({
            ...
            success: function (obj) {
                pic = file_path_pic + obj.pIC;
                $("#audio").attr("src", file_path_songs + obj.mP3);
                getReady(obj.lRC);
            }
        })
        ...
        $(this).css({
            "background": 'url("/portal/css/images/T1X4JEFq8qXXXaYEA_-11-12.gif") no-repeat',
            "color": "transparent"
        });
