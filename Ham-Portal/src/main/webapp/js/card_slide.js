...
// <img class="swiper-slide${this.clsSuffix}" style="width: ${this.imgWidth}px;height:${this.imgWidth};" src="${resImgArr[index].imgPath}" />
//
// </a>
// `;

            src = src + `<div>
<div style="width: 300px;height: 300px;position: absolute;left: -200px;;" class="swiper-slide${this.clsSuffix}">
<a href="${resImgArr[index].url}">
<img src="${resImgArr[index].imgPath}" style="width: 241px;height: 241px;margin:5px;border-radius: 5%;"/>
</a>
<div>
